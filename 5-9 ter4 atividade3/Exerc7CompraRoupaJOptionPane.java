...
public class Exerc7CompraRoupaJOptionPane {
    public static void main(String[] args) {
        double valorReal = Double.parseDouble(JOptionPane.showInputDialog("Digite o valor da roupa em R$: "));
        int escolha = Integer.parseInt(JOptionPane.showInputDialog("Escolha o número correspondente a opção de pagamento: " + 
        "\n0-Compra à vista" + "\n1-Compra parcelada no cartão" + "\n2-Crediário"));
        ...
        switch (escolha) {
            case 0:
                JOptionPane.showMessageDialog(null, "Pagamento à vista selecionado. Valor de: R$" + String.format("%.2f",valor0)+".");
                break;
            case 1:
                int parcelas1 = Integer.parseInt(JOptionPane.showInputDialog("Digite a quantidade de parcelas: "));
                double valor1 = valorReal / parcelas1;
                JOptionPane.showMessageDialog(null,"Parcelamento realizado em " + parcelas1 +" vezes de R$" + String.format("%.2f",valor1 )+ ".");
                break;
            case 2:
                int parcelas2 = Integer.parseInt(JOptionPane.showInputDialog("Digite a quantidade de parcelas: "));
                double juros = (1.0/10) * valorReal;
                double valor2 = juros +valorReal;
                double valor2parcelado = valor2 / parcelas2;
                JOptionPane.showMessageDialog(null,"Parcelamento realizado em " + parcelas2 +" vezes de R$" +
