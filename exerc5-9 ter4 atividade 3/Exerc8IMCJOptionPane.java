...
public class Exerc8IMCJOptionPane {
    public static void main(String[] args) {
        
        double peso = Double.parseDouble(JOptionPane.showInputDialog("Defina seu peso (kg): "));
        double altura = Double.parseDouble(JOptionPane.showInputDialog("Defina sua altura (em m): "));
